...
const memebership = document.getElementById('memberShip')


const submitBtn = document.getElementById('submit')

submitBtn.addEventListener('click',event=>{
  if(!email.validity.valueMissing && !firstName.validity.valueMissing &&!lastName.validity.valueMissing && !birthDay.validity.valueMissing && !gender.validity.valueMissing && !phoneNumber.validity.valueMissing && !memebership.validity.valueMissing){
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        let res = JSON.parse(response)
        if(res){
          window.location.href='registeredlist.jsp'
        }
        else{
